...
const productsToCreate = [
  ...
  // Add EMR v2 - GRIDS recipe
  {
    displayName: 'EMR from GRIDS',  // Please make sure the display name is unique in this list
    filename: 'grids-emr-cluster', // This is the name of your file you've added in the step above
    description: `An Amazon EMR research workspace that comes with: \n* Hail 0.2 \n* Jupyter Lab \n* Spark 2.4.4 \n* Hadoop 2.8.5`,
  },
];
